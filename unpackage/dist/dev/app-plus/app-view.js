...
var x=['./components/common/card.wxml','./components/common/divider.wxml','./components/common/loading.wxml','./components/uni-ui/uni-badge/uni-badge.wxml','./components/uni-ui/uni-icon/uni-icon.wxml','./components/uni-ui/uni-list-item/uni-list-item.wxml','./pages/class/class.wxml','./pages/person/person.wxml','./pages/photo/photo.wxml','./pages/user-set/user-set.wxml','./pages/user-userinfo/user-userinfo.wxml'];d_[x[0]]={}
...
var xWB=_mz(z,'loading',['bind:__l',2,'show',1,'vueId',2],[],e,s,gg)
_(oVB,xWB)
var oXB=_mz(z,'scroll-view',['scrollY',-1,'class',5,'style',1],[],e,s,gg)
var fYB=_v()
_(oXB,fYB)
var cZB=function(o2B,h1B,c3B,gg){
var l5B=_mz(z,'view',['bindtap',11,'class',1,'data-event-opts',2,'hoverClass',3],[],o2B,h1B,gg)
var a6B=_n('view')
_rz(z,a6B,'class',15,o2B,h1B,gg)
var t7B=_oz(z,16,o2B,h1B,gg)
_(a6B,t7B)
_(l5B,a6B)
_(c3B,l5B)
return c3B
...
fYB.wxXCkey=2
_2z(z,9,cZB,e,s,gg,fYB,'item','index','index')
_(oVB,oXB)
var e8B=_mz(z,'scroll-view',['scrollY',-1,'bindscroll',17,'data-event-opts',1,'scrollTop',2,'scrollWithAnimation',3,'style',4],[],e,s,gg)
var b9B=_v()
_(e8B,b9B)
var o0B=function(oBC,xAC,fCC,gg){
var hEC=_n('view')
_rz(z,hEC,'class',26,oBC,xAC,gg)
var oFC=_v()
_(hEC,oFC)
var cGC=function(lIC,oHC,aJC,gg){
var eLC=_n('view')
_rz(z,eLC,'class',31,lIC,oHC,gg)
var bMC=_mz(z,'image',['mode',-1,'src',32,'style',1],[],lIC,oHC,gg)
_(eLC,bMC)
_(aJC,eLC)
return aJC
}
oFC.wxXCkey=2
_2z(z,29,cGC,oBC,xAC,gg,oFC,'item2','index2','index2')
_(fCC,hEC)
return fCC
}
b9B.wxXCkey=2
_2z(z,24,o0B,e,s,gg,b9B,'item','index','index')
_(oVB,e8B)
_(r,oVB)
return r
}
...
_(oPC,hSC)
_(xOC,oPC)
var eZC=_mz(z,'uni-list-item',['bind:__l',21,'leftIcon',1,'leftIconStyle',2,'showExtraIcon',3,'title',4,'vueId',5],[],e,s,gg)
_(xOC,eZC)
var b1C=_mz(z,'uni-list-item',['bind:__l',27,'leftIcon',1,'leftIconStyle',2,'showExtraIcon',3,'title',4,'vueId',5],[],e,s,gg)
_(xOC,b1C)
var o2C=_mz(z,'divider',['bind:__l',33,'vueId',1],[],e,s,gg)
_(xOC,o2C)
var x3C=_mz(z,'uni-list-item',['bind:__l',35,'leftIcon',1,'leftIconStyle',2,'showExtraIcon',3,'title',4,'vueId',5],[],e,s,gg)
_(xOC,x3C)
var o4C=_mz(z,'uni-list-item',['bind:__l',41,'leftIcon',1,'leftIconStyle',2,'showExtraIcon',3,'title',4,'vueId',5],[],e,s,gg)
_(xOC,o4C)
var f5C=_mz(z,'divider',['bind:__l',47,'vueId',1],[],e,s,gg)
_(xOC,f5C)
var c6C=_mz(z,'uni-list-item',['bind:__l',49,'bind:click',1,'data-event-opts',2,'leftIcon',3,'leftIconStyle',4,'showExtraIcon',5,'title',6,'vueId',7],[],e,s,gg)
_(xOC,c6C)
_(r,xOC)
return r
}
...
var xGD=_mz(z,'card',['bind:__l',4,'bodyStyle',1,'headTitle',2,'vueId',3,'vueSlots',4],[],eDD,tCD,gg)
var oHD=_v()
_(xGD,oHD)
var fID=function(hKD,cJD,oLD,gg){
var oND=_mz(z,'uni-list-item',['bind:__l',13,'bind:click',1,'data-event-opts',2,'title',3,'vueId',4],[],hKD,cJD,gg)
_(oLD,oND)
return oLD
}
oHD.wxXCkey=4
_2z(z,11,fID,eDD,tCD,gg,oHD,'list','listIndex','listIndex')
_(bED,xGD)
return bED
}
lAD.wxXCkey=4
...
var aPD=_mz(z,'button',['class',19,'type',1],[],e,s,gg)
...
var z=gz$gwx_11()
var bSD=_n('view')
var oTD=_mz(z,'divider',['bind:__l',0,'vueId',1],[],e,s,gg)
_(bSD,oTD)
var xUD=_mz(z,'uni-list-item',['bind:__l',2,'title',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var oVD=_n('view')
_rz(z,oVD,'slot',6,e,s,gg)
var fWD=_mz(z,'image',['class',7,'src',1,'style',2],[],e,s,gg)
_(oVD,fWD)
_(xUD,oVD)
_(bSD,xUD)
var cXD=_mz(z,'uni-list-item',['bind:__l',10,'title',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var hYD=_n('view')
_rz(z,hYD,'slot',14,e,s,gg)
var oZD=_oz(z,15,e,s,gg)
_(hYD,oZD)
_(cXD,hYD)
_(bSD,cXD)
var c1D=_mz(z,'uni-list-item',['bind:__l',16,'title',1,'vueId',2],[],e,s,gg)
_(bSD,c1D)
var o2D=_mz(z,'uni-list-item',['bind:__l',19,'title',1,'vueId',2],[],e,s,gg)
_(bSD,o2D)
var l3D=_mz(z,'divider',['bind:__l',22,'vueId',1],[],e,s,gg)
_(bSD,l3D)
var a4D=_mz(z,'uni-list-item',['bind:__l',24,'title',1,'vueId',2],[],e,s,gg)
_(bSD,a4D)
var t5D=_mz(z,'uni-list-item',['bind:__l',27,'title',1,'vueId',2],[],e,s,gg)
_(bSD,t5D)
_(r,bSD)
return r
}
