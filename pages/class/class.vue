<template>
	...
	style="height: 100%;box-sizing: border-box;">
		...
		<scroll-view scroll-y style="flex:1;height: 100%;" class="border-right border-light-secondary">
			<view class="border-button border-light-secondary py-1 left-scroll-item" hover-class="bg-light-secondary"
		...
		@scroll="onRightScroll">
			<view class="row right-scroll-item" v-for="(item, index) in list" :key="index">
				<view class="span24-12 text-center "
				v-for="(item2, index2) in item.list" :key="index2">
					<image :src="item2.src" mode="" style="width: 320upx;height: 520upx;"></image>
				</view>
			</view>
		</scroll-view>
	</view>
